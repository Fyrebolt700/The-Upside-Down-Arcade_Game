...
function load_level_1 () {
    ...
    if (intro) {
        game.showLongText("Here is the story: blah blah", DialogLayout.Full)
        game.showLongText("Step 1: move left and right", DialogLayout.Top)
        game.showLongText("step 2 go upside down", DialogLayout.Top)
        game.showLongText("step 3 freeze enemies", DialogLayout.Top)
